			...
			<div id="formulario_briefing_projeto" class="form_arquivo">
				...
				<?php foreach($briefingprojeto['BriefingResposta'] as $key => $value ) { ?>
					<div class="entrada_dados">
						...
						<?php echo $this->Form->hidden('BriefingResposta.'.$key.'.id'); ?>
						<?php echo $this->Form->hidden('BriefingResposta.'.$key.'.pergunta', array('value' => $value['pergunta'])) ?>
				...
				<div class="btn_enviar">
					...
					<?php echo $this->Form->submit('Salvar', array('div'=>false,'id'=>'btn_enviar_briefing')); ?>					
				</div>
			</div>
